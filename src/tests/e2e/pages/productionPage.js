...
var productionPage = Object.create(page, {
    ...
    clickProduction28KPI: {
        value: function () {
            ...
            expect(this.filtreAetBPourACP28Value.getText()).not.toBe("N/A");
        }
    },
    ...
    clickProduction28KPILevel2: {
        value: function () {
            ...
            expect(this.volumeDeProductionPourACP28Value.getText()).not.toBe("N/A");
        }
    },
    ...
    clickProduction54KPI: {
        value: function () {
            ...
            expect(this.echelonJQuantiteDeProduction54Value.getText()).not.toBe("N/A");
            expect(this.echelonKQuantiteDeProduction54.getText()).toBe("Quantité de production (TP2O5)");
            expect(this.echelonKQuantiteDeProduction54Value.getText()).not.toBe("N/A");
            expect(this.echelonLQuantiteDeProduction54.getText()).toBe("Quantité de production (TP2O5)");
            expect(this.echelonLQuantiteDeProduction54Value.getText()).not.toBe("N/A");
    ...
    clickProduction54KPIEchelonJ: {
        value: function () {
            ...
            expect(this.echelonJVolumeDeProduction54Value.getText()).not.toBe("N/A");
    ...
    clickProduction54KPIEchelonK: {
        value: function () {
            ...
            expect(this.echelonKVolumeDeProduction54Value.getText()).not.toBe("N/A");
    ...
    clickProduction54KPIEchelonL: {
        value: function () {
            ...
            expect(this.echelonLVolumeDeProduction54Value.getText()).not.toBe("N/A");
